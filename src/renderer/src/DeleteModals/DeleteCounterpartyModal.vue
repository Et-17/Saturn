...
import { ref } from 'vue';
import { delete_counterparty, UUID } from '../account_management/ledger_state';
...
function remove() {
  delete_counterparty(props.counterpartyUuid)
    .catch(() => error_message.value = "Error deleting counterparty")
...
<template>
  ...
  <Modal :active=active>
    <div>
      Are you <strong>sure</strong> that you want to delete this counterparty? <br>
