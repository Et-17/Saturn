...
<template>
  <div id="counterparties">
    <div id="counterparties-top-bar">
      ...
      <span v-if="currently_viewing != null" id="back-button-counterparty" @click="currently_viewing = null">Back</span>
    </div>
    <CounterpartiesTable v-if="currently_viewing == null" @open-counterparty="(uuid: UUID) => currently_viewing = uuid" />
